...
public class HttpUtil {
	public static final String OAUTH2_SERVER_IP = "http://localhost";
	public static final String OAUTH2_SERVER_PORT = "8003";

	public static final String RES_SERVER_IP = "http://localhost";
	public static final String RES_SERVER_PORT = "8002";
	...
	public static String getOauth2ServerBaseUrl() {
		StringBuffer baseUrlBuffer = new StringBuffer();
		baseUrlBuffer.append(OAUTH2_SERVER_IP);
		if(OAUTH2_SERVER_PORT != null) {
			baseUrlBuffer.append(":").append(OAUTH2_SERVER_PORT);
		}
		return baseUrlBuffer.toString();
	}
	
	public static String getResourceServerBaseUrl() {
		StringBuffer baseUrlBuffer = new StringBuffer();
		baseUrlBuffer.append(RES_SERVER_IP);
		if(RES_SERVER_PORT != null) {
			baseUrlBuffer.append(":").append(RES_SERVER_PORT);
		}
		return baseUrlBuffer.toString();
	}
